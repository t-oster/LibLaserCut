 ...
 * @author oster
 */
public class PowerSpeedFocusProperty extends AbstractLaserProperty
{
  ...
  {
    addPropertyRanged("power", 0, 0, 100);
    addPropertyRanged("speed", 100, 0, 100);
    if (!hideFocus) addProperty("focus", 0);
