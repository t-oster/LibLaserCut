 ...
 */
public class DummySvg extends LaserCutter {
  ...
  class SVGWriter  {
    ...
    void storeXHTML(String path, String svgString) {
      ...
      try {
        InputStream stream = new DummySvg().getClass().getResourceAsStream("resources/visicut-svg-output-viewer.xhtml");
...
private void writeJob(SVGWriter svg, LaserJob job) throws IllegalJobException, Exception {
