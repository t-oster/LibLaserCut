...
//
//    instance.setRasteringCutDirectionLeftToRight();
//    assertEquals(0, instance.cutForward ? 0 : 1);
//
//    instance.toggleRasteringCutDirection();
//    assertEquals(1, instance.cutForward ? 0 : 1);
//  }
//
//  /**
...
//    for (int i = 0; i <= 7; i++)
//    {
//      assertEquals(false, instance.cutForward ? (i > instance.rightMostNonWhitePixel(0)) : (i < instance.leftMostNonWhitePixel(0)));
//    }
//    // once you get to pixel 8, the line is cut
//    assertEquals(true, instance.cutForward ? (8 > instance.rightMostNonWhitePixel(0)) : (8 < instance.leftMostNonWhitePixel(0)));
//
//    // cut <- ---X--XX-
//    instance.toggleRasteringCutDirection();
...
//    for (int i = 8; i >= 3; i--)
//    {
//      assertEquals(false, instance.cutForward ? (i > instance.rightMostNonWhitePixel(1)) : (i < instance.leftMostNonWhitePixel(1)));
//    }
//    // once you get to pixels 2-0 (heading left), the line is cut
//    for (int i = 2; i >= 0; i--)
//    {
//      assertEquals(true, instance.cutForward ? (i > instance.rightMostNonWhitePixel(1)) : (i < instance.leftMostNonWhitePixel(1)));
//    }
//  }
//
//  /**
...
//    // cut -> --XX-XXX-
//    instance.setRasteringCutDirectionLeftToRight();
//    assertEquals(2, instance.cutForward ? instance.leftMostNonWhitePixel(0) : instance.rightMostNonWhitePixel(0));
//
//    // cut <- ---X--XX-
//    instance.toggleRasteringCutDirection();
//    assertEquals(7, instance.cutForward ? instance.leftMostNonWhitePixel(1) : instance.rightMostNonWhitePixel(1));
//
//    // cut -> 303333333
//    instance.toggleRasteringCutDirection();
//    assertEquals(0, instance.cutForward ? instance.leftMostNonWhitePixel(2) : instance.rightMostNonWhitePixel(2));
//
//    // cut <- 007777777
//    instance.toggleRasteringCutDirection();
//    assertEquals(8, instance.cutForward ? instance.leftMostNonWhitePixel(3) : instance.rightMostNonWhitePixel(3));
//  }
//
//  /**
...
//
//  /**
//   * Test of getPowerSpeedFocusPropertyForPixel method, of class
//   * RasterizableJobPart.
//   */
//  @Test
...
//
//  /**
//   * Test of getPowerSpeedFocusPropertyForColor method, of class
//   * RasterizableJobPart.
//   */
//  @Test
...
//    assertEquals(9, x);
//
//    boolean done = instance.cutForward ? (x > instance.rightMostNonWhitePixel(y)) : (x < instance.leftMostNonWhitePixel(y));
...
//    {
//      // set image data
//      BufferedImage image = new BufferedImage(9, 6, BufferedImage.TYPE_BYTE_GRAY);
//
//      // key...
...
//      int[] data = new int[]
//      {
//        0xFFFFFFFF, 0xFFFFFFFF, 0xFF000000, 0xFF000000, 0xFFFFFFFF, 0xFF000000, 0xFF000000, 0xFF000000, 0xFFFFFFFF,
//        0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0, 0xFFFFFFFF, 0xFFFFFFFF, 0, 0, 0xFFFFFFFF,
//        0xFF3F3F3F, 0xFFFFFFFF, 0xFF3F3F3F, 0xFF3F3F3F, 0xFF3F3F3F, 0xFF3F3F3F, 0xFF3F3F3F, 0xFF3F3F3F, 0xFF3F3F3F,
//        0xFFFFFFFF, 0xFFFFFFFF, 0xFF7F7F7F, 0xFF7F7F7F, 0xFF7F7F7F, 0xFF7F7F7F, 0xFF7F7F7F, 0xFF7F7F7F, 0xFF7F7F7F,
//        0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
//        0xFF000000, 0xFF000000, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF
//      };
//      image.setRGB(0, 0, 9, 6, data, 0, 9);
//
//      // set image data
//      this.image = image;
//
