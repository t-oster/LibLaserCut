...
public class RasterizableJobPartTest
{
  ...
  public void testHasFinishedCuttingLine()
  {
    ...
    for (int i = 0; i <= 7; i++)
    {
      assertEquals(false, instance.hasFinishedCuttingLine(i, 0));
    }
    ...
    for (int i = 8; i >= 3; i--)
    {
      assertEquals(false, instance.hasFinishedCuttingLine(i, 1));
    }
    // once you get to pixels 2-0 (heading left), the line is cut
    for (int i = 2; i >= 0; i--)
    {
      assertEquals(true, instance.hasFinishedCuttingLine(i, 1));
    }
  }
